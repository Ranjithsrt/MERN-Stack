   ...
   return (
     <div className="max-w-2xl mx-auto space-y-8 py-6">
       <button
         ...
         className="flex items-center gap-2 text-slate-400 hover:text-orange-600 transition-all font-bold uppercase tracking-widest text-[10px] group"
       >
         <ChevronLeft
           size={16}
       ...
       <div className="bg-white rounded-xl p-10 lg:p-14 shadow-sm border border-slate-100 relative overflow-hidden">
         <div className="mb-8 p-6 bg-slate-50/50 border border-slate-100 rounded-lg flex items-center justify-between relative z-10">
           <div>
             <p className="text-[9px] text-slate-400 font-bold uppercase tracking-widest mb-1 whitespace-nowrap">
               Available
             </p>
             <p className="text-2xl font-bold text-slate-800 tabular-nums tracking-tighter">
         ...
         <form className="space-y-8 relative z-10" onSubmit={handleSubmit}>
           <div className="space-y-4">
             ...
             <div className="relative group/input">
               <span className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-200 font-bold text-2xl group-focus-within/input:text-orange-500 transition-colors">
                 ₹
               </span>
               <input
                 type="number"
