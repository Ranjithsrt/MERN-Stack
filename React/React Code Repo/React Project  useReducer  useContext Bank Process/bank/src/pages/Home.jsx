      ...
      <div className="max-w-lg w-full ">
        ...
        <div className="bg-white rounded-2xl p-10 lg:p-14 shadow-sm border border-white">
          ...
          <form className="space-y-7" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4.5 rounded-lg transition-all duration-300 shadow-lg shadow-indigo-100 active:scale-[0.98] text-sm uppercase tracking-widest">
