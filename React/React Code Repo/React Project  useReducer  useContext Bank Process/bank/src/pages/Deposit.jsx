...
const Deposit = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-6">
      <button onClick={() => navigate("/dashboard")} className="flex items-center gap-2 text-slate-400 hover:text-indigo-600 transition-all font-bold uppercase tracking-widest text-[10px] group">
      ...
      <div className="flex items-center gap-6 mb-2 px-2">
        ...
        <div>
          ...
          <p className="text-slate-400 font-bold uppercase tracking-widest text-[9px] mt-1 opacity-70">Add funds to reserves</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl p-10 lg:p-14 shadow-sm border border-slate-100 relative overflow-hidden">
        <form className="space-y-8 relative z-10" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <label className="block text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">Memo</label>
            <input
              type="text"
              value={description}
          ...
          <button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 rounded-lg transition-all duration-300 shadow-lg shadow-indigo-100 active:scale-[0.98] text-sm uppercase tracking-widest">
            Confirm
          </button>
        </form>
      </div>
