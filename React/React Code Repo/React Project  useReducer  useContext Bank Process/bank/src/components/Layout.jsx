        ...
        <div className="px-4 mt-auto">
          <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 relative overflow-hidden group">
            <div className="relative z-10 text-center">
              ...
              <button className="w-full mt-2 py-2 bg-white border border-slate-200 rounded-lg text-[10px] font-bold text-slate-700 hover:border-indigo-200 transition-all uppercase">Get Help</button>
            </div>
          </div>
        </div>

        <div className="px-8 mt-6">
          <button onClick={() => dispatch({ type: "RESET" })} className="flex items-center gap-2 text-slate-400 hover:text-rose-500 transition-all font-bold text-[12px] uppercase tracking-tighter">
            <LogOut size={14} />
            <span>Sign Out</span>
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-20 bg-white border-b border-[#eef0f7] px-8 flex items-center justify-between sticky top-0 z-20">
          <div className="relative max-w-sm w-full">
            ...
            <input type="text" placeholder="search" className="w-full bg-[#f8fafc] border border-slate-100 rounded-lg py-2 pl-12 pr-4 text-sm font-medium focus:outline-none focus:bg-white focus:border-indigo-100 transition-all placeholder:text-slate-300" />
          </div>
