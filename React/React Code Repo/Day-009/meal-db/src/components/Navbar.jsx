      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6 text-slate-600 font-medium">
          ...
          <Link to="/favorites" className="bg-slate-100 p-2 rounded-full transition-all group relative">
            ...
            <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] w-5 h-5 flex items-center justify-center font-bold rounded-full">{favorites.length}</span>
          </Link>
        </div>
      </div>
    </nav>
