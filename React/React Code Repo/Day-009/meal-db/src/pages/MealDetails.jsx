    ...
    <div className="max-w-6xl mx-auto">
      <div className="grid md:grid-cols-2 gap-10">
        <div className="relative">
          ...
          <button className="absolute top-6 right-6 p-4 bg-white rounded-full shadow-lg hover:scale-110 transition-transform" onClick={() => toggleFavorite(meal)}>
            <Heart size={28} className={isFavorite(meal.idMeal) ? "fill-red-500 text-red-500" : "text-slate-300"} />
          </button>
        </div>
