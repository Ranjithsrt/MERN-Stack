  ...
  return (
    <nav className="bg-white/80 border-b border-slate-300 sticky top-0 z-50 mb-6 backdrop-blur-md">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <a href="#" className="flex items-center gap-2 text-orange-500 font-black text-2xl">
          <ChefHat size={32} />
        ...
        <div className="flex items-center gap-6 text-slate-600 font-medium">
          ...
          <a href="#" className="bg-slate-100 p-2 rounded-full transition-all group relative">
